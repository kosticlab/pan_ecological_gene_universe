...
hmmsearch --noali --tblout ${outputdir}/${hmm_nopath}_prev.txt --domtblout ${outputdir}/${hmm_nopath}_domain.txt -E 0.001 --domE 0.001 --cpu 5 ${hmm} /n/data1/joslin/icrb/kostic/szimmerman/OV2_fig3_4_complete_linkage/GTDB_analysis/presence_in_consensus_genes/consensus_global_conservative_genes_50perc.faa > ${outputdir}/${hmm_nopath}.stdout
done < ${hmm_file}
