...
for(k in 1:length(ggplots_50PCs)) {
  ...
  pdf(paste("umaps_multi_params/ggplots_50PCs_minclust_",minclust_size_temp,"_v2.pdf",sep=""),width=18,height=18)
