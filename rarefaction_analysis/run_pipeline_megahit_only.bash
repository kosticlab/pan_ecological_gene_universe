...
#rm ${f1} take this out so I don't remove original files
#rm ${f2}
...
megahit --mem-flag 2 --num-cpu-threads ${thread_number} -1 ${output_folder}/${dirname}/${dirname}_human_free_1.fastq -2 ${output_folder}/${dirname}/${dirname}_human_free_2.fastq -o ${output_folder}/${dirname}/${dirname}_mh_out
...
find ${output_folder}/${dirname}/${dirname}_mh_out -not -name 'final.contigs.fa' -delete
# run prokka
...
#rm ${filenames} take this out so I leave original files alone
# remove human reads
